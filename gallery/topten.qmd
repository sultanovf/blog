---
title: "Top ten countries by GDP, PPP"
description: "top ten countries worldwide in terms of GDP by purchasing power parity (PPP) over the years, shown by animated plot using `ggplot2` and `gganimate`"
...
categories: [barplot, R, ggplot2, gganimate, dplyr, geom_image]
...
# variables =====================================================================
imgpat <- "gallery_img/topten/"  # path for flags
...
dataraw <- read.csv2("https://raw.githubusercontent.com/sultanovf/my_datasets/refs/heads/main/gdp_ppp.csv", sep = ";",encoding = "utf-8") # , sep = ";",encoding = "utf-8"
...
### top 10 countries by each year <br>
(showing 20 head)
...
df_plt <- 
  df_top |> 
  mutate(cflags = paste0("gallery_img/topten/", ccode, ".png")) |>
  mutate(
    country = case_when(
...
df_plt |>  
  ...
  ggplot(aes(x = reorder(country, gdp), y = gdp)) +
    ...
    labs(
      x = NULL, y = "GDP, PPP in Tsd.(k = 1000) Mlrd. USD", 
